...
CREATE TABLE `login_password_credentials` (
  `id` int(11) NOT NULL,
  `login` varchar(255) NOT NULL,
  `password` varchar(255) NOT NULL
);
--
-- Indexes for table `login_password_credentials`
--
ALTER TABLE `login_password_credentials`
  ADD PRIMARY KEY (`id`);
--
-- AUTO_INCREMENT for table `login_password_credentials`
--
ALTER TABLE `login_password_credentials`
  ALTER COLUMN `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `users`
  ADD CONSTRAINT `FK_login_password_credentials` FOREIGN KEY (`credentials_id`) REFERENCES `login_password_credentials` (`id`);
ALTER TABLE `users`
...
ALTER TABLE `roles_map`
  ADD CONSTRAINT `FK_role_map_to_roles` FOREIGN KEY (`roles_id`) REFERENCES `roles` (`id`);
ALTER TABLE `roles_map`
  ADD CONSTRAINT `FK_roles_map_to_users` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);
